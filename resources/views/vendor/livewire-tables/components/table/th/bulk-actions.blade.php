    ...
    <x-livewire-tables::table.th.plain>
        ...
        >
            <input
                ...
                @class([
                    'rounded-[3px] border-gray-300 text-[#0d8a72] shadow-sm transition duration-150 ease-in-out focus:border-[#0d8a72] focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600' => $theme === 'tailwind',
