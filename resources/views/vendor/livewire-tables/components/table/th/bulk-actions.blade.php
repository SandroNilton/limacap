...
@if ($component->bulkActionsAreEnabled() && $component->hasBulkActions())
    ...
    <x-livewire-tables::table.th.plain>
        <div
            ...
            @class([
                'inline-flex rounded-full shadow-sm' => $theme === 'tailwind',
        ...
        >
            <input
                ...
                @class([
                    'rounded-full border-gray-300 text-[#10B981] shadow-sm transition duration-150 ease-in-out focus:border-[#0d8a72] focus:ring focus:ring-gray-200 focus:ring-opacity-50 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600' => $theme === 'tailwind',
