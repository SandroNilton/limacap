  ...
  <div class="grid grid-cols-1 gap-6 divide-x-4 divide-red-600 md:grid-cols-3 lg:grid-cols-4">
      ...
      <div>
        <div class="bg-white bg-opacity-100 border-b border-opacity-100 rounded-md border-[rgb(229,231,235)] shadow p-4">
          <div class="flex justify-between mb-5">
            <h4 class="w-full text-opacity-100 text-[rgb(17,24,39)] font-extrabold text-center uppercase mb-3">DETALLE DEL TRAMITE</h4>
          </div>
    ...
    <div class="col-span-2 space-y-6">
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2">
        <div class="bg-white bg-opacity-100 border-b border-opacity-100 rounded-md border-[rgb(229,231,235)] shadow p-4">
          <h4 class="w-full text-opacity-100 text-[rgb(17,24,39)] font-extrabold text-center uppercase mb-3">APROBACION DOCUMENTARIA</h4>
          <div class="flex justify-between mb-5">
          ...
          <div class="bg-white bg-opacity-100 border-b border-opacity-100 rounded-md border-[rgb(229,231,235)] shadow p-4">
            ...
            <form wire:submit.prevent="assignState" enctype="multipart/form-data">
              ...
              <div class="w-full text-center items-center self-center flex">
                <button type="submit" class="items-center px-3 py-1.5 bg-[#10B981] rounded-md font-medium uppercase text-xs text-white tracking-widest focus:outline-none focus:ring-0 transition ease-in-out duration-150">
                  Finalizar
                </button>
              </div>
            </form>
